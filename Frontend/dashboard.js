...
//     });
//   };
//   // Normalize incoming fields to an array of strings.
//   function normalizeListField(obj, keys) {
//     // keys: array of candidate key names, in priority order
//     for (let k of keys) {
//       if (!obj) continue;
...
//         if (typeof v === "string") {
//           // try JSON / Python-list like string
//           try {
...
//   fillList(
//     "col-left-precautions",
//     normalizeListField(left, ["precautions", "Precautions"])
//   );
//   fillList(
//     "col-left-meds",
//     normalizeListField(left, [
//       "medications",
//       "meds",
//       "Medication",
//       "medication",
...
//   fillList(
//     "col-left-diets",
//     normalizeListField(left, ["diets", "diet", "Diet", "Diets"])
//   );
//   fillList(
//     "col-left-workouts",
//     normalizeListField(left, [
...
//     right.description || "";
//   fillList(
//     "col-right-precautions",
//     normalizeListField(right, ["precautions", "Precautions"])
//   );
//   fillList(
//     "col-right-meds",
//     normalizeListField(right, [
//       "medications",
//       "meds",
//       "Medication",
//       "medication",
...
//   fillList(
//     "col-right-diets",
//     normalizeListField(right, ["diets", "diet", "Diet", "Diets"])
//   );
//   fillList(
//     "col-right-workouts",
//     normalizeListField(right, [
